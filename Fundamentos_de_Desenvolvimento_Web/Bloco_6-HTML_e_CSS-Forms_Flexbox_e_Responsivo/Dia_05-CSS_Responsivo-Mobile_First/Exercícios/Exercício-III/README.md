...
<div style="text-align: center">
  <img src="imgs/exercise_3_before_print.png" alt="Visualização da página antes da impressão"/><br>
  <label for="">Visualização da página antes da impressão</label>
</div><br>
...
<div style="text-align: center">
  <img src="imgs/exercise_3_before_small_phone.png" alt="240x320: tela pequena"/><br>
  <label for="">240x320: tela pequena</label>
</div><br>

<div style="text-align: center">
  <img src="imgs/exercise_3_before_android.png" alt="360x640 tela de smartphone"/><br>
  <label for="">360x640 tela de smartphone</label>
</div>