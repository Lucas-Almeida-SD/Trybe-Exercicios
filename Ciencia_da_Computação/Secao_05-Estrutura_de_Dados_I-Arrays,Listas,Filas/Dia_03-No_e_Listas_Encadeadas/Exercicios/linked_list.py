...
class LinkedList:
    ...
    def insert_first(self, value):
        ...
        if self.head_value:
            self.head_value.previous = Node(first_value.value)
    ...
    def insert_last(self, value):
        ...
        last_value.previous = Node(current_value.value)
    ...
    def insert_at(self, value, position):
        ...
        next_value.previous = Node(current_value.value)
    ...
    def remove_at(self, position):
        ...
        value_to_be_removed.next.previous = Node(previous_to_be_removed.value)
        value_to_be_removed.next = None
        value_to_be_removed.previous = None
        self.__length -= 1
